    ...
    <div className="w-full sticky top-0 z-[1000] flex justify-center bg-transparent p-4">
      <header className="w-full max-w-[80rem] p-4 sm:p-6 flex items-center justify-between bg-white shadow rounded-3xl">
        ...
        >
          ...
          />
          {!isSearchActive && (
            <span className="text-lg sm:text-xl md:text-2xl font-semibold hover:text-gray-900 transition">
              NepseDai
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-4 ml-4">
          <button
            ...
            className="relative p-2 rounded-full hover:drop-shadow-[0_0_6px_rgba(1,1,1,0.7)] transition"
          ...
          <button
            ...
            className="p-2 rounded-full hover:drop-shadow-[0_0_6px_rgba(1,1,1,0.7)] transition"
