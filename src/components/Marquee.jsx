...
const MarqueeSection = ({ marketData }) => {
  const extendedData = [...marketData, ...marketData, ...marketData, ...marketData];

  const lines = [
    { type: 'large', data: randomSequence(extendedData, 12), speed: 40, reverse: true },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 30, reverse: false },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 50, reverse: true },
    { type: 'large', data: randomSequence(extendedData, 12), speed: 40, reverse: false },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 30, reverse: true },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 50, reverse: false },
    { type: 'large', data: randomSequence(extendedData, 12), speed: 40, reverse: true },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 30, reverse: false },
    { type: 'small', data: randomSequence(extendedData, 25), speed: 50, reverse: true }
  ];
